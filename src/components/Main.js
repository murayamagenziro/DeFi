    ...
    render(){
        return (
            <div id="content" className="mt-3">
                <table className="table table-borderless center-align text-muted text-center">
                    <thead>
                        <tr>
                            ...
                            <div className='input-group mb-4'>
                                ...
                                <div className="input-group-append">
                                    <div className="input-group-text">
                                        <img src={jam} height= '32'alt="jam logo" />
                                        &nbsp;&nbsp;&nbsp; JAM
                                    </div>
                                </div>                             
                            </div>
                            <button type="submit" className="btn btn-primary btn-block bnt-lg">STAKE!</button>
